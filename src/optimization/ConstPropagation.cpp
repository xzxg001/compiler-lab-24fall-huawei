...
#define IS_GLOBAL_VARIABLE(l_val) dynamic_cast<GlobalVariable *>(l_val)  // 判断是否为全局变量
#define IS_GEP_INSTR(l_val) dynamic_cast<GetElementPtrInst *>(l_val)  // 判断是否为GetElementPtr指令
...
std::map<Value *, Value *> const_val_stack;// 存储常量值的栈
